...
- Two-word, one-line instruction prefetch cache
...
| `0x08` | FEATURES | `0x00000021`: M enabled and two cache words |
...
are: 1 UART, 2 SPI, 3 I2C, 4 GPIO, 5 timer 0, 6 timer 1, 7 watchdog; ID 8 is
