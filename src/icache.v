// -----------------------------------------------------------------------------
// icache.v
// One-line instruction cache / prefetch buffer shared by serial flash/PSRAM.
//
// LINE_WORDS may be 1, 2, 4 or 8. The default of four words is a 16-byte line.
// This is intentionally only one cache line: it captures sequential instruction
// fetches without consuming much ASIC area. FENCE.I invalidates it.
// -----------------------------------------------------------------------------
module icache #(
