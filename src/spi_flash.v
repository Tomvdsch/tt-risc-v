            ...
            case (state)
                ...
                ST_READ: begin
                    if (!phase) begin
                        ...
                        flash_sck  <= 1'b1;
                        phase      <= 1'b1;
                        byte_shift <= {byte_shift[5:0],flash_miso};
                        if (bit_in_byte == 3'd7) begin
                            case (byte_in_word)
                                2'd0: rd_data[7:0]   <= {byte_shift,flash_miso};
                                2'd1: rd_data[15:8]  <= {byte_shift,flash_miso};
                                2'd2: rd_data[23:16] <= {byte_shift,flash_miso};
                                2'd3: begin
                                    rd_data <= {{byte_shift,flash_miso},rd_data[23:0]};
                                    rd_valid <= 1'b1;
                                end
                            endcase
                        end
