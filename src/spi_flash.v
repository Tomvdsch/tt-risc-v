// -----------------------------------------------------------------------------
// spi_flash.v
// Minimal read-only SPI controller for Winbond W25Q64JV-class NOR flash.
// Uses command 0x03 (normal read), 24-bit address, SPI mode 0.
//
// The SoC only needs reads at run time: firmware is normally programmed into
// the flash externally. Keeping erase/program logic out of first silicon saves
// area and prevents accidental self-erasure during bring-up.
// -----------------------------------------------------------------------------
module spi_flash (
    input  wire        clk,
    input  wire        rst_n,
