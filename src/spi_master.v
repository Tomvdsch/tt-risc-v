// -----------------------------------------------------------------------------
// spi_master.v - small 8-bit SPI master with programmable mode and divider.
// Base: 0x1000_3000
//   0x00 DATA    R: last received byte; W: start transfer
//   0x04 STATUS  bit0 ready, bit1 done (write CTRL bit7 to clear)
//   0x08 CTRL    bit0 CPOL, bit1 CPHA, bit2 LSB-first, bit3 IRQ-enable,
//                bit7 clear-done
//   0x0C DIV     SCK half-period in system clocks (>=1)
//   0x10 CS      bit0=1 asserts CS, bit0=0 deasserts CS
// -----------------------------------------------------------------------------
module spi_master #(
